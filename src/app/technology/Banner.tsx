  ...
  return (
      <section className='w-full relative h-screen  overflow-hidden rounded-xl shadow-md mb-10'>
        <Image src={banner} alt='Technology' fill className='object-cover brightness-75'/>
          ...
          <h1 className='text-5xl justify-center items-center pt-40 md:pt-44 w-full  font-extrabold mb-4 drop-shadow-lg '>Empowering the Future with Cutting-Edge Technolog</h1>
